                    ...
                    <div>
                      ...
                      <div className="relative group">
                        ...
                        <Field
                          ...
                          className={`block w-full pl-10 pr-12 py-3 border transition-all duration-200 focus:ring-2 focus:ring-offset-2 leading-relaxed ${
                    ...
                    <div>
                      ...
                      <div className="relative group">
                        ...
                        <Field
                          ...
                          id="confirmPassword"
                          autoComplete="new-password"
                          className={`block w-full pl-10 pr-12 py-3 rounded-b-xl border transition-all duration-200 focus:ring-2 focus:ring-offset-2 leading-relaxed ${
